...
```
This lets you run them directly, e.g. `service_monitor.sh status nginx`, from anywhere.

## 4. Verify installation
```bash
./scripts/network_check.sh interfaces
./scripts/service_monitor.sh report
```
